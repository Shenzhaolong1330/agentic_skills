...
Usage:
  ...
  run_single_pick_tube_insert_rack.sh --mode live --hardware-allowed --execute [options]
...
PREFLIGHT_CMD=(python3 "$REPO_ROOT/scripts/hardware_preflight.py" --operation single --mode live)
